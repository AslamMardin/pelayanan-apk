...
@section('judul_halaman', 'TAMBAH KEBUTUHAN')
      ...
      <div class="col-sm-12 col-md-6 p-5 bg-white shadow-LG">
         <form action="{{route('kebutuhan.store')}}" method="post">
            ...
            <div class="mb-3">
               ...
               <input type="text" name="harga" id="harga" class="form-control @error('harga') is-invalid @enderror" autocomplete="off" value="{{old('harga')}}">
