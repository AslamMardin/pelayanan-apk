...
@section('judul_halaman', 'TAMBAH JEMPUT')
      ...
      <div class="col-sm-12 col-md-6 p-5 bg-white shadow-LG">
         <form action="{{route('jemput.store')}}" method="post">
            ...
            <div class="mb-3">
               ...
               <input type="text" name="barang" class="form-control @error('barang') is-invalid @enderror" autocomplete="off" value="{{old('barang')}}">
               @error('barang')
               <div class="text-danger text-sm m-1">{{ $message }}</div>
               @enderror
            </div>
            ...
            <div class="mb-3">
               ...
               <input type="text" name="transportasi" id="transportasi" class="form-control @error('transportasi') is-invalid @enderror" autocomplete="off" value="{{old('transportasi')}}">
